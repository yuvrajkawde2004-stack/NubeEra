import { LogOut, Key, UserCheck, ChevronDown, Menu } from 'lucide-react';
            ...
            {isDropdownOpen && (
              ...
              >
                <div className="px-6 py-5 border-b border-slate-100 mb-2">
                  <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mb-2">Profile</p>
